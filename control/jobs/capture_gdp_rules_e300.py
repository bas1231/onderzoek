...
root=Path.cwd()
url='https:'+chr(47)+chr(47)+'gamma-api.polymarket.com/events/79137'
...
out=outdir/(stamp+'event_79137.json')
out.write_bytes(raw)

print('GDP_RULE_CAPTURE_PASS')
print('HTTP',status)
...
print('DESCRIPTION')
print(str(event.get('description') or '')[:8000])
