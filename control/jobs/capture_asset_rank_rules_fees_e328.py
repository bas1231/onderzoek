...
root=Path.cwd()
url='https:'+chr(47)+chr(47)+'gamma-api.polymarket.com/events/106981'
...
out=outdir/(stamp+'event_106981.json')
out.write_bytes(raw)

print('ASSET_RULE_FEE_CAPTURE_PASS')
print('HTTP',status)
