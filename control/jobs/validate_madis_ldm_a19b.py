...
CHECK 3/3 end-to-end replay: immutable manifest-proven A19A NOAA OMO gzip
through A19B.
...
FILES = [
    ...
    WEATHER / "a19a_proven_replay_fixture.py",
    WEATHER / "test_a19a_proven_replay_fixture.py",
]
...
try:
    ...
    fixture_test = run(sys.executable, str(WEATHER / "test_a19a_proven_replay_fixture.py"), timeout=60)
    check1 = bool(
        unit.returncode == 0
        and "MADIS_LDM_A19B_UNIT_TESTS_PASS" in unit.stdout
    ...
    result["checks"]["check_1_technical"] = {
        ...
        "fixture_test_stderr": fixture_test.stderr[-2000:],
    }
